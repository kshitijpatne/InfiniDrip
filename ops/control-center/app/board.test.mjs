...
test("admitted Epic 14 and its active research lanes match the future backlog", () => {
  ...
  const expectedLaneStatus = { A: "Backlog", B: "Done", C: "Done", D: "In Progress" };
  ...
  for (const id of ["EPIC-14-C01", "EPIC-14-C02", "EPIC-14-C05", "EPIC-14-C06"]) {
    ...
    assert.equal(packet?.status, ["EPIC-14-C01", "EPIC-14-C02", "EPIC-14-C05"].includes(id) ? "Done" : "In Progress");
