...
import { Measurements, GarmentRecipe, GarmentOptions } from "../drafting";
...
export function guide(recipe: GarmentRecipe, m: Measurements, options: GarmentOptions = {}): Note[] {
  ...
  // measurement.
  return [
    ...recipe.guidance(block, m, options),
