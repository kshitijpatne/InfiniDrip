...
export const MEASUREMENT_BOUNDS: Partial<Record<keyof Measurements, Bound>> = {
  ...
  crotchDepth: { min: 16, max: 40, label: "Sitting crotch depth" },
  thigh: { min: 40, max: 90, label: "Thigh girth" },
  knee: { min: 30, max: 70, label: "Knee girth" },
  inseam: { min: 55, max: 105, label: "Finished inseam" },
